...
task.spawn(function() 
	while task.wait() do
		if _G.Auto_Farm_Level then
			pcall(function()
				--[[if _G.TweentoQuest == false and not game:GetService("Workspace").Enemies:FindFirstChild(NameMon) then
					Tween(_G.PosMonLv) UnEquipWeapon(_G.Select_Weapon)
				    BringMobFarm = false
				end
				if _G.TweentoQuest == true and not game:GetService("Workspace").Enemies:FindFirstChild(NameMon) and game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
					UnEquipWeapon(_G.Select_Weapon)
				    BringMobFarm = false
				end
				if _G.TweentoQuest == true and not game:GetService("Workspace").Enemies:FindFirstChild(NameMon) and game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
					Tween(_G.PosMonLv)
					UnEquipWeapon(_G.Select_Weapon)
				    BringMobFarm = false
				end]]
					...
					if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
						if game:GetService("Workspace").Enemies:FindFirstChild(NameMon) then
							...
							if not game:GetService("Workspace").Enemies:FindFirstChild(NameMon) then
								if World1 and (NameMon == "Fishman Commando" or NameMon == "Fishman Warrior") and (NPCPosition.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000 then
									game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
								elseif World1 and not (NameMon == "Fishman Commando" or NameMon == "Fishman Warrior") and (NPCPosition.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000 then
									game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(3864.8515625, 6.6796875, - 1926.7841796875))
								elseif World2 and string.find(NameMon, "Ship") and (NPCPosition.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 30000 then
									game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(923.21252441406, 126.9760055542, 32852.83203125))
								elseif World2 and not string.find(NameMon, "Ship") and (NPCPosition.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 30000 then
...
function EquipBloxFruitt()
	pcall(function()
		if _G.Auto_Farm_Mastery_Fruit and game:GetService("Workspace").Enemies:FindFirstChild(NameMon) then
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if v.Name == NameMon then
					if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
						game:GetService 'VirtualUser':CaptureController() game:GetService 'VirtualUser':Button1Down(Vector2.new(1280, 672))
...
spawn(function()
	while task.wait() do
		if _G.Brimob and _G.Auto_Farm_Level then
			pcall(function()
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					if BringMobFarm and (NameMon == "Factory Staff" or NameMon == "Monkey" or NameMon == "Yeti" or NameMon == "The Gorilla King" or NameMon == "Gorilla" or NameMon == "Dragon Crew Warrior" or NameMon == "Dragon Crew Archer") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 280 then
